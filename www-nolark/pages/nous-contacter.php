...
<html lang="fr-FR">
    <head>
        <title>Nous Contacter Norlak</title>
    ...
    <body>
        ...
        <section id="carto">
            ...
            <img src="https://open.mapquestapi.com/staticmap/v5/map?key=bZNXQieHCY65xphzmzAPLTH1EQSKUDq0&locations=Toulon,Var,France%7Chttp://gil83.fr/nolark/marqueur_nolark.png&center=Chateauroux,Indre,France&zoom=6&size=590,610" alt="Carte OpenStreetMap statique avec le pays de Nolark">
            <img src="https://open.mapquestapi.com/staticmap/v5/map?key=bZNXQieHCY65xphzmzAPLTH1EQSKUDq0&locations=Avenue%20Winston%20Churchill,%20Toulon,%20Var,%20Provence-Alpes-Cote%20d'Azur,%20France%20metropolitaine,%2083041,%20France%7Chttp://gil83.fr/nolark/marqueur_nolark.png&zoom=13&size=306,300" alt="Carte OpenStreetMap statique avec la ville de Nolark">
            <img src="https://open.mapquestapi.com/staticmap/v5/map?key=bZNXQieHCY65xphzmzAPLTH1EQSKUDq0&locations=43.12546,%205.92672%7Chttp://gil83.fr/nolark/marqueur_nolark.png&zoom=17&size=306,300" alt="Carte OpenStreetMap statique avec l'emplacement de Nolark">
        </section>
        <section id="contact">
